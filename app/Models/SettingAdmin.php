...
class SettingAdmin extends Model
{
  ...
  public function calculatePrice($place, $checkin, $checkout, $numOfadults){
    ...
    $AllPrices = SettingAdmin::orderBy('id')->get();
      ...
      if ($checkin1 >= strtotime("2022-06-01") && $checkin1 <= strtotime("2022-06-11") && $checkout2 <= strtotime("2022-06-11")) {

        echo "June 01 -> June 11 only";
      ...
      if ($checkin1 >= strtotime("2022-06-12") && $checkin1 <= strtotime("2022-06-30") && $checkout2 <= strtotime("2022-06-30")) {

        
        echo "June 12 -> June 30 only";
      ...
      if ($checkin1 >= strtotime("2022-07-01") && $checkin1 <= strtotime("2022-08-31") && $checkout2 <= strtotime("2022-08-31")) {

        
        echo "Juky 01 -> July 31 only";
      ...
      if ($checkin1 >= strtotime("2022-09-01") && $checkin1 <= strtotime("2022-09-11") && $checkout2 <= strtotime("2022-09-11")) {

        
        echo "Agust 01 -> Agust 11 only";
      ...
      if ($checkin1 >= strtotime("2022-09-12") && $checkin1 <= strtotime("2022-09-30") && $checkout2 <= strtotime("2022-09-30")) {

        
        echo "Agust 12 -> Agust 30 only";

        if (SettingAdmin::checkWeekOrNot($checkin) == 0) {
          if ($numOfadults == 1) {
            $price_tm += $AllPrices[4]->adult1_price;
          } else if ($numOfadults == 2) {
            $price_tm += $AllPrices[4]->adult2_price;
          } else if ($numOfadults == 3) {
            $price_tm += $AllPrices[4]->adult3_price;
          } else if ($numOfadults == 4) {
            $price_tm += $AllPrices[4]->adult4_price;
          }
        } else {
          if ($numOfadults == 1) {
            $price_tm += $AllPrices[4]->adult1_price_weekend;
          } else if ($numOfadults == 2) {
            $price_tm += $AllPrices[4]->adult2_price_weekend;
          } else if ($numOfadults == 3) {
            $price_tm += $AllPrices[4]->adult3_price_weekend;
          } else if ($numOfadults == 4) {
            $price_tm += $AllPrices[4]->adult4_price_weekend;
          }
        }
