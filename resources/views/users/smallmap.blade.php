      ...
      <div class="col-sm-8 offset-sm-1">
        <h2 id ="heading_qt">{{ __('Book your favorite place on the map') }}</h2>
              <form action="" method="HEAD" id="datepickerform">
                ...
                @else
                  <span id="errormsg_txt1" class="text-primary"> {{ __('You have to book for minimum') }} <?php if($maparray['set_admin']->day == "1") {echo "60";} if($maparray['set_admin']->day == "2") {echo "30";} if($maparray['set_admin']->day == "3") {echo "15";} ?> {{ __('days') }}.</span><br>
                @endisset
                      ...
                      <div class="row">
                        <div class="col-sm-8 col-12">
                          ...
                          @isset($maparray['err_msg'])
                            <span id="errormsg_txt" style="color:red;">{{ __('You have to book for minimum') }} <?php if($maparray['set_admin']->day == "1") {echo "60";} if($maparray['set_admin']->day == "2") {echo "30";} if($maparray['set_admin']->day == "3") {echo "15";} ?> {{ __('days') }}.</span><br>
                          @endisset
